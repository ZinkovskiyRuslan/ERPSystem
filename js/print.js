            ...
            init: function() {
                ...
                switch (void 0 === e ? "undefined" : i(e)) {
                    case "string":
						...
						t.documentTitle = arguments[2] || t.documentTitle;
                        break;
                    case "object":
                ...
                var o = void 0;
                switch ((o = document.createElement("iframe")).setAttribute("style", "visibility: hidden; height: 0; width: 0; position: absolute;"),o.src="uuurl", o.setAttribute("id", t.frameId), "pdf" !== t.type && (o.srcdoc = "<html><head><title>" + t.documentTitle + "</title>", null !== t.css && (Array.isArray(t.css) || (t.css = [t.css]), t.css.forEach(function(e) {
